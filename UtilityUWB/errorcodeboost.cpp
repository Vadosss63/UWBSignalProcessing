...
bool ErrorCodeBoost::IsNoError() const noexcept { return !m_errorCode.value(); }

void ErrorCodeBoost::ClearErrors() noexcept { m_errorCode.clear(); }

ErrorCode &ErrorCodeBoost::GetErrors() noexcept { return m_errorCode; }
