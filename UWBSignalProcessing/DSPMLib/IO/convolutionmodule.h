...
public:
    ...
    void LetConv( csignal<double> &in1,csignal<double> &in2, const std::vector<double> &filter);
    void LetConv(std::vector<double> &in, const std::vector<double> &filter);
    dspm::csignal<double> LetSimpConv(csignal<double> &in, const std::vector<double> &filter);
