...
class SourceModule : public AbstractModule
{
...
template<typename BufferTypeOut>
SourceModule<BufferTypeOut>::~SourceModule()
{
...
template<typename BufferTypeOut>
OutputPort<BufferTypeOut>*SourceModule<BufferTypeOut>::GetOutput(uint8_t port)
{
...
template<typename BufferTypeOut>
void SourceModule<BufferTypeOut>::PushToOutput(const BufferTypeOut& element, uint8_t outputNo)
{
    m_outputPorts.at(outputNo)->PushToOutput(element);
}

template<typename BufferTypeOut>
void SourceModule<BufferTypeOut>::PushToOutput(BufferTypeOut&& element, uint8_t outputNo)
{
