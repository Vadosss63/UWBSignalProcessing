...
public:
    enum FilterType
    {
       ...
       MinMaxParksMcClelannFilter(const int& num_taps, const int& n_bands,std::vector<double> &bands_edge, const std::vector<double> &desire, const std::vector<double> &weight, const FilterType& type, const int& grid_density, const int& max_iterations);
...
///////////Секция внутренних членов класса
      ...
      std::vector<int> ext; ///Вектор экстремальных частот, расположенных на нашей сетке
...
////////////////Основные методы класса
      ...
      ///Создание густой сетки частот и "натягивание" на нее желаемой АЧХ фильтра и весовых коэффициентов
      void CreateDenseGrid(const int& numtaps, const int& numband, std::vector<double> &bands, const std::vector<double>& des, const std::vector<double>& weight, const int &grid_density);
      ...
      void remez(const int& num_taps, const int& n_bands, std::vector<double> &bands_edge, const std::vector<double> &desire, const std::vector<double> &weight, const FilterType& type, const int& grid_density, const int& max_iterations);
