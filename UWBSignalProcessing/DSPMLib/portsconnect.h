...
template<typename BufferType>
bool OutputPort<BufferType>::Connected() const
{
...
template<typename BufferType>
void OutputPort<BufferType>::Disconnect()
{
    if (Connected())
...
template<typename BufferType>
InputPort<BufferType>::~InputPort()
{
    Disconnect();
}
...
template<typename BufferType>
void InputPort<BufferType>::ClearDataQueue()
{
...
template<typename BufferType>
bool InputPort<BufferType>::Connected() const
{
    return m_connectedOutputPort;
}

template<typename BufferType>
bool InputPort<BufferType>::Empty() const
{
...
bool InputPort<BufferType>::Connect(OPort* newBack)
{
    ...
    OutputPort<BufferType>* outputPort = dynamic_cast<OutputPort<BufferType>*>(newBack);
...
template<typename BufferType>
void InputPort<BufferType>::Disconnect()
{
