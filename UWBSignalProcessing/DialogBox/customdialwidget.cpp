...
int CustomDialWidget::minVal() const { return m_minVal; }
...
double CustomDialWidget::getDisplayVal() { return m_LCD->value(); }

int CustomDialWidget::getDisplayIntVal() { return m_LCD->intValue(); }

void CustomDialWidget::setValue(int Val) { m_Dial->setValue(Val); }

int CustomDialWidget::maxVal() const { return m_maxVal; }
