...
private:
    ...
    void SetStyleSchemeWindow(QString path = QString("StyleSheet/MainWindow.qss"));
...
public:
    ...
    NameSchemeDialog(const QString& msg = "Введите новое название для даной схемы", QWidget *wparent = nullptr);
