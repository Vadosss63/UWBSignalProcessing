...
AbstractDialogCommand::AbstractDialogCommand(QWidget *parent)
  ...
  connect(m_applyButton, SIGNAL(clicked()), this,
          SLOT(SendCommandAbstractModule()));
...
void AbstractDialogCommand::SendCommand() { Notification(); }
...
void AbstractDialogCommand::SendCommandAbstractModule() { SendCommand(); }
