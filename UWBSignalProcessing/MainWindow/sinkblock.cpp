...
void SinkBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
    DrawRect(painter, option);
}

QVariant SinkBlock::itemChange(QGraphicsItem::GraphicsItemChange change, const QVariant& value)
{
...
QVector<IPortBlock*> SinkBlock::GetInPort() const
{
    return m_port;
}
