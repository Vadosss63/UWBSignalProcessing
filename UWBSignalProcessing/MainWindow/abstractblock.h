...
public:
    ...
    virtual void RegistrOperationManager(AbstractOperationManager* operationManager) = 0;
...
// абстрактный класс для графических блоков, отвечающий за отображения начального прямоугольника и
