...
QList<AbstractBlock *> LouderBlocks::Loud(const QString &path) {
  ...
  foreach (QString fileName, dir.entryList(QDir::Files)) {
    ...
    BilderBlocks *bilderBlocks =
        qobject_cast<BilderBlocks *>(loader.instance());
    if (bilderBlocks)
...
DatabaseBlocks::DatabaseBlocks() { LoudBlock(); }
...
DatabaseBlocks::~DatabaseBlocks() { DeleteBlock(); }

QList<AbstractBlock *> DatabaseBlocks::SourceBlocks() const { return m_source; }

QList<AbstractBlock *> DatabaseBlocks::IOBlocks() const { return m_io; }

QList<AbstractBlock *> DatabaseBlocks::SinkBlocks() const { return m_sink; }
