...
ChangeSizeSignalBlock::ChangeSizeSignalBlock() : IOBlock("SizeSig") {
...
void ChangeSizeSignalBlock::paint(QPainter *painter,
...
void ChangeSizeSignalBlock::RegistrOperationManager(
