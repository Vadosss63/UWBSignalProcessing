...
AccumPhaserBlock::AccumPhaserBlock():
    IOBlock("Накопление")
{
...
AbstractModule* AccumPhaserBlock::GetModule() const
{
    return m_module.get();
}

QString AccumPhaserBlock::GetType() const
{
    return "AccumPhaserBlock";
}
...
void AccumPhaserBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void AccumPhaserBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
