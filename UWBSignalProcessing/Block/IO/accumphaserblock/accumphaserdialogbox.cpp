...
double AccumPhaserDialogBox::GetPhase()
{
    return m_wPhase->getDisplayIntVal();
}
...
QList<std::pair<QString, QVariant> > AccumPhaserDialogBox::GetSetting()
{
    ...
    listSetting.append(std::make_pair("m_wCountAccum", m_wCountAccum->getDisplayIntVal()));
    return listSetting;
}

bool AccumPhaserDialogBox::SetSetting(QList<std::pair<QString, QVariant> > listSetting)
{
