...
CosTransferBlock::CosTransferBlock() : IOBlock("Cos"), m_module(nullptr) {
...
AbstractModule *CosTransferBlock::GetModule() const { return m_module.get(); }

QString CosTransferBlock::GetType() const { return "CosTransferBlock"; }
...
void CosTransferBlock::paint(QPainter *painter,
...
AbstractBlock *PluginBlock::LoudBlock() const { return new CosTransferBlock; }

void CosTransferBlock::RegistrOperationManager(
