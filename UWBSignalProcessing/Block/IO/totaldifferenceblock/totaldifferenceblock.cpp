...
QString TotalTifferenceBlock::GetType() const
{
    return "TotalTifferenceBlock";
}

void TotalTifferenceBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void TotalTifferenceBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
