...
SplitterBlock::SplitterBlock() : IOBlock("Делитель") {
  setToolTip("Принимая сигнал на один входной порт,\nвыталкивает его в два "
             "выходных порта");
}

AbstractBlock *SplitterBlock::Clone() const { return new SplitterBlock(); }

AbstractModule *SplitterBlock::GetModule() const { return m_module.get(); }

QString SplitterBlock::GetType() const { return "SplitterBlock"; }
...
void SplitterBlock::paint(QPainter *painter,
...
void SplitterBlock::ChangeCountPorts() { CreateBlockPorts(); }
...
AbstractBlock *PluginBlock::LoudBlock() const { return new SplitterBlock; }

void SplitterBlock::RegistrOperationManager(
