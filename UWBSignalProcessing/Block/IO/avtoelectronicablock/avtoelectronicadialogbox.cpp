...
bool AvtoelectronicaDialogBox::SetSetting(QList<std::pair<QString, QVariant> > listSetting)
{
...
int AvtoelectronicaDialogBox::GetMaxSpeed()
{
    return m_maxSpeed->value();
}

bool AvtoelectronicaDialogBox::IsVARU()
{
    return m_varu->isChecked();
}

double AvtoelectronicaDialogBox::GetGain()
{
    return m_gain->value();
}
...
AvtoelectronicaDialogBox::AvtoelectronicaDialogBox()
{
    CreateWidget();
}
