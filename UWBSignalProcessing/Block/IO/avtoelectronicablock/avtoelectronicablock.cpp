...
QString AvtoelectronicaBlock::GetType() const
{
    return "AvtoelectronicaBlock";
}
...
void AvtoelectronicaBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void AvtoelectronicaBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
