...
ControlAntennsBlock::ControlAntennsBlock():
    IOBlock("Антенна"){}
...
QString ControlAntennsBlock::GetType() const
{
    return "ControlAntennsBlock";
}

void ControlAntennsBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void ControlAntennsBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
