...
TwoGainBlock::TwoGainBlock() : IOBlock("TwoGain"), m_image(6) {
  setToolTip(
      "Формирует сигнал из двух, путем склеивания первой\n части от первого и "
      "второй от второго,\n раздеителем является индекс нового усиления");
}

AbstractBlock *TwoGainBlock::Clone() const { return new TwoGainBlock(); }

AbstractModule *TwoGainBlock::GetModule() const { return m_module.get(); }

QString TwoGainBlock::GetType() const { return "TwoGainBlock"; }
...
void TwoGainBlock::paint(QPainter *painter,
...
AbstractBlock *PluginBlock::LoudBlock() const { return new TwoGainBlock; }

void TwoGainBlock::RegistrOperationManager(
