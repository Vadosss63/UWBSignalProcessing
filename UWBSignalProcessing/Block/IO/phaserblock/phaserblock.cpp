...
PhaserBlock::PhaserBlock() : IOBlock("ФВ") {
  setToolTip("Выполняет изменение фазы сигнала");
}

AbstractBlock *PhaserBlock::Clone() const { return new PhaserBlock(); }

AbstractModule *PhaserBlock::GetModule() const { return m_module.get(); }

QString PhaserBlock::GetType() const { return "PhaserBlock"; }
...
void PhaserBlock::paint(QPainter *painter,
...
AbstractBlock *PluginBlock::LoudBlock() const { return new PhaserBlock; }

void PhaserBlock::RegistrOperationManager(
