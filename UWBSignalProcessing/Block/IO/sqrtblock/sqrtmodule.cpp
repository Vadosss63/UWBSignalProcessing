...
{    
    ...
    if(m_isSqrt)
    {
        ...
        //        std::transform(temp1arg.begin(),temp1arg.end(), temp2arg.begin(), temp1arg.begin(),
        //                       [](double re, double im){ return std::atan(im/re)*180/3.14;});
...
void SqrtModule::SetIsSqrt(bool isSqrt)
{
    m_isSqrt = isSqrt;
}
