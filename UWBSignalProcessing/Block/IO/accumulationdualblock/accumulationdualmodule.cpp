...
///  Накопление
//////////////////////////////////////////
AccumulationDualModule::AccumulationDualModule() : IOModule(1, 1) {}
...
uint32_t AccumulationDualModule::azimuth() const { return m_azimuth; }

void AccumulationDualModule::buffer(csignal<double> &signal) {
  signal = std::move(m_sumSignal);
}

void AccumulationDualModule::SetAzimuth(const uint32_t &az) { m_azimuth = az; }
