...
AbstractBlock *TradeBlock::Clone() const { return new TradeBlock(); }

AbstractModule *TradeBlock::GetModule() const { return m_module.get(); }

QString TradeBlock::GetType() const { return "TradeBlock"; }
...
void TradeBlock::paint(QPainter *painter,
...
AbstractBlock *PluginBlock::LoudBlock() const { return new TradeBlock; }

void TradeBlock::RegistrOperationManager(
