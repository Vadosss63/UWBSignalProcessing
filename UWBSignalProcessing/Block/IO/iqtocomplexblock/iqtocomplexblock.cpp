...
IQToComplexBlock::IQToComplexBlock() : IOBlock("IQ2Complex") {
  setToolTip(
      "Принимает на вход квадратуры, на выходе выдает комплексный сигнал");
}
...
AbstractModule *IQToComplexBlock::GetModule() const { return m_module.get(); }

QString IQToComplexBlock::GetType() const { return "IQToComplexBlock"; }

void IQToComplexBlock::Change() {}

void IQToComplexBlock::paint(QPainter *painter,
...
void IQToComplexBlock::ChangeCountPorts() { CreateBlockPorts(); }
...
AbstractBlock *PluginBlock::LoudBlock() const { return new IQToComplexBlock; }

void IQToComplexBlock::RegistrOperationManager(
