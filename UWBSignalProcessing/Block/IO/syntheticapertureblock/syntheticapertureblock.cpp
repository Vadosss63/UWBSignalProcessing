...
void SyntheticApertureBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void SyntheticApertureBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
