...
SyntheticApertureModule::SyntheticApertureModule():
    IOModule(1, 1){}
...
void SyntheticApertureModule::SyntheticAperture()
{
    ...
    signal.setServiceParameters(m_bufferAperture.front().azimuth(), m_bufferAperture.front().frameNumber());
...
void SyntheticApertureModule::AccumSignal(csignal<double>& signal, size_t start, size_t stop, size_t countAntennes)
{
...
void SyntheticApertureModule::ClearBuffer()
{
    m_bufferAperture.clear();
}
