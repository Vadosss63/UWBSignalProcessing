...
AbstractBlock *RangeAccumBlock::Clone() const { return new RangeAccumBlock(); }

AbstractModule *RangeAccumBlock::GetModule() const { return m_module.get(); }

QString RangeAccumBlock::GetType() const { return "RangeAccumBlock"; }
...
void RangeAccumBlock::paint(QPainter *painter,
...
AbstractBlock *PluginBlock::LoudBlock() const { return new RangeAccumBlock; }

void RangeAccumBlock::RegistrOperationManager(
