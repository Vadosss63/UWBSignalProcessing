...
class RangeAccumModule : public IOModule<InBuffer,  std::vector<std::valarray<double>>>
{
...
public:
    ...
    void SetSetting(size_t countAcumm, size_t startRange, size_t range, double threshol);
...
private:
    ...
    void IndicatingAdapteThreshol(std::vector<std::valarray<double>>& data, size_t i);
