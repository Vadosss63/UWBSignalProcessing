...
IQtoMagnitudeBlock::IQtoMagnitudeBlock() :
    IOBlock("IQtoMA")
{
...
AbstractModule* IQtoMagnitudeBlock::GetModule() const
{
    return m_module.get();
}

QString IQtoMagnitudeBlock::GetType() const
{
    return "IQtoMagnitudeBlock";
}

void IQtoMagnitudeBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void IQtoMagnitudeBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
