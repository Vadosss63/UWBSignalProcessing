...
void AvtoelectronicaRawModule::SetSetting(size_t countAcumm, size_t startRange, size_t range, double threshol, double thresholDynamic)
{
...
void AvtoelectronicaRawModule::SetRangeLook(int xBegin, int xEnd, int yBegin, int yEnd)
{
    m_xBegin = xBegin;
    m_xEnd = xEnd;
    m_yBegin = yBegin;
