...
QList<std::pair<QString, QVariant> > AvtoelectronicaRawDialogBox::GetSetting()
{
    ...
    listSetting.append(std::make_pair("m_thresholDynamic", m_thresholDynamic->value()));
...
bool AvtoelectronicaRawDialogBox::SetSetting(QList<std::pair<QString, QVariant> > listSetting)
{
...
size_t AvtoelectronicaRawDialogBox::GetNumberRange()
{
    return static_cast<size_t>(m_numberRange->value());
}

size_t AvtoelectronicaRawDialogBox::GetCountAcumm()
{
    return static_cast<size_t>(m_countAcumm->value());
}

size_t AvtoelectronicaRawDialogBox::GetRangeAcumm()
{
    return static_cast<size_t>(m_range->value());
}

double AvtoelectronicaRawDialogBox::GetThresholAcumm()
{
    return static_cast<double>(m_threshol->value());
}

double AvtoelectronicaRawDialogBox::GetThresholAcummDynamic()
{
    return static_cast<double>(m_thresholDynamic->value());
}

double AvtoelectronicaRawDialogBox::GetBaseAntenna()
{
    return m_baseAntenna->value();
}

int AvtoelectronicaRawDialogBox::GetMaxSpeed()
{
    return m_maxSpeed->value();
}

bool AvtoelectronicaRawDialogBox::IsVARU()
{
    return m_varu->isChecked();
}

double AvtoelectronicaRawDialogBox::GetGain()
{
    return m_gain->value();
}

double AvtoelectronicaRawDialogBox::GetGainDynamic()
{
    return m_gainDynamic->value();
}

void AvtoelectronicaRawDialogBox::CreateWidget()
{
...
AvtoelectronicaRawDialogBox::AvtoelectronicaRawDialogBox()
{
    CreateWidget();
}
