...
bool AvtoelectronicaRawDialogBox::SetSetting(
    QList<std::pair<QString, QVariant>> listSetting) {
...
int AvtoelectronicaRawDialogBox::GetMaxSpeed() { return m_maxSpeed->value(); }

bool AvtoelectronicaRawDialogBox::IsVARU() { return m_varu->isChecked(); }

double AvtoelectronicaRawDialogBox::GetGain() { return m_gain->value(); }
...
AvtoelectronicaRawDialogBox::AvtoelectronicaRawDialogBox() { CreateWidget(); }
