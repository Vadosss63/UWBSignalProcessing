...
int BinDialogBox::GetShiftI() const { return m_shiftI->value(); }

int BinDialogBox::GetShiftQ() const { return m_shiftQ->value(); }

int BinDialogBox::GetRangeUp() const { return m_rangeUp->value(); }

int BinDialogBox::GetRangeBottom() const { return m_rangeBottom->value(); }
