...
public:
  // конструктор принимает параметр nIteration - число итераций прежде чем
  // выталкнуть в порт
...
class ConstAndSendIterationAccumulation
    : public AbstractAccumulation /// надо доделать!!!
{
...
// а на место его записывается другой). Накаждой итерации происходит
// выталкивание сигнала с усреднением на итерацию (до n-й итерации) и с
// усреднением на n (после n-й итерации)
