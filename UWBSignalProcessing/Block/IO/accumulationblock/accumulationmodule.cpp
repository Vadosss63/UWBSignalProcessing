...
//////////////////////////////////////////
AbstractAccumulation::AbstractAccumulation(size_t sizeBuf)
    : m_buffer(sizeBuf), m_sizeBuf(sizeBuf) {}
...
bool AbstractAccumulation::BufEmpty() const { return m_buffer.empty(); }
uint32_t AbstractAccumulation::azimuth() const { return m_azimuth; }
...
size_t AbstractAccumulation::nIteration() const { return m_buffer.size(); }

//////////////////////////////////////////
///Константное накопление
//////////////////////////////////////////

ConstAccumulation::ConstAccumulation(size_t sizeBuf)
    : AbstractAccumulation(sizeBuf) {}
...
ConstAndSendIterationAccumulation::ConstAndSendIterationAccumulation(
    size_t sizeBuf)
    : AbstractAccumulation(sizeBuf) {}
...
CyclicAccumulation::CyclicAccumulation(size_t sizeBuf)
    : AbstractAccumulation(sizeBuf) {}
