...
AbstractModule *CorrelationBlock::GetModule() const { return m_module.get(); }

QString CorrelationBlock::GetType() const { return "CorrelationBlock"; }

void CorrelationBlock::paint(QPainter *painter,
...
AbstractBlock *PluginBlock::LoudBlock() const { return new CorrelationBlock; }

void CorrelationBlock::RegistrOperationManager(
