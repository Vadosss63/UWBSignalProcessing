...
ScanBlock::ScanBlock() : IOBlock("scan") {
  setToolTip("Создает скан из набора сигналов");
}

AbstractBlock *ScanBlock::Clone() const { return new ScanBlock(); }

AbstractModule *ScanBlock::GetModule() const { return m_module.get(); }

QString ScanBlock::GetType() const { return "ScanBlock"; }

void ScanBlock::paint(QPainter *painter, const QStyleOptionGraphicsItem *option,
                      QWidget *) {
...
void ScanBlock::ChangeCountPorts() { CreateBlockPorts(); }
...
AbstractBlock *PluginBlock::LoudBlock() const { return new ScanBlock; }

void ScanBlock::RegistrOperationManager(
