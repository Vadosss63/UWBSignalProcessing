...
AbstractBlock *SMABlock::Clone() const { return new SMABlock(); }

AbstractModule *SMABlock::GetModule() const { return m_module.get(); }

QString SMABlock::GetType() const { return "SMABlock"; }
...
void SMABlock::paint(QPainter *painter, const QStyleOptionGraphicsItem *option,
                     QWidget *) {
...
AbstractBlock *PluginBlock::LoudBlock() const { return new SMABlock; }

void SMABlock::RegistrOperationManager(
