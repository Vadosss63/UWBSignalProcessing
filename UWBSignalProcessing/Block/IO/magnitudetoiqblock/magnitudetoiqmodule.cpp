...
Magnitude_AngleModuleToIQModule::Magnitude_AngleModuleToIQModule() :
    IOModule(static_cast<uint8_t>(2), static_cast<uint8_t>(2)), TempFFT(2048)
{
    plan_fft = fftw_plan_dft_1d (TempFFT.size(), (fftw_complex*) &TempFFT[0], (fftw_complex*) &TempFFT[0], FFTW_BACKWARD, FFTW_ESTIMATE);
}
...
{
    TempFFT.reset(len);
    plan_fft = fftw_plan_dft_1d (TempFFT.size(), (fftw_complex*) &TempFFT[0], (fftw_complex*) &TempFFT[0], FFTW_FORWARD, FFTW_ESTIMATE);
}
