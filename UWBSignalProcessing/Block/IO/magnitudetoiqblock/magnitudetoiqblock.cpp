...
MagnitudetoIQBlock::MagnitudetoIQBlock() :
    IOBlock("MAtoIQ")
{
...
AbstractModule* MagnitudetoIQBlock::GetModule() const
{
    return m_module.get();
}

QString MagnitudetoIQBlock::GetType() const
{
    return "MagnitudetoIQBlock";
}

void MagnitudetoIQBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void MagnitudetoIQBlock::DrawImage(QPainter *painter)
{
    ...
    painter->drawText(static_cast<int>(rect.left()) + 10, static_cast<int>(rect.top()) + 20, "A");
    painter->drawText(static_cast<int>(rect.left()) + 3, static_cast<int>(rect.bottom()) - 10, "|M|");
    painter->drawText(static_cast<int>(rect.right()) - 12, static_cast<int>(rect.top()) + 20, "I");
    painter->drawText(static_cast<int>(rect.right()) - 15, static_cast<int>(rect.bottom()) - 10, "Q");
...
void MagnitudetoIQBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
