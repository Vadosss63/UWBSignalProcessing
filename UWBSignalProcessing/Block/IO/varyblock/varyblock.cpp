...
AbstractBlock* VARYBlock::Clone() const
{
    return new VARYBlock();
}

AbstractModule* VARYBlock::GetModule() const
{
    return m_module.get();
}

QString VARYBlock::GetType() const
{
    return "VARYBlock";
}
...
void VARYBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void VARYBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
