...
ThresholdDialogBox::ThresholdDialogBox()
{
    CreateWidget();
}

double ThresholdDialogBox::GetThreshold()
{
...
bool ThresholdDialogBox::SetSetting(QList<std::pair<QString, QVariant> > listSetting)
{
