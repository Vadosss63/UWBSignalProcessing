...
QList<std::pair<QString, QVariant>> SinGeneratorDialogBox::GetSetting()
{
    ...
    listSetting.append(std::make_pair("m_frequency", m_frequency->getDisplayIntVal()));
...
bool SinGeneratorDialogBox::SetSetting(QList<std::pair<QString, QVariant>> listSetting)
{
