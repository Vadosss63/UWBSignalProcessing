...
ReceiverUDPBlock::ReceiverUDPBlock() : SourceBlock("UDP") {
...
AbstractModule *ReceiverUDPBlock::GetModule() const { return m_module.get(); }

QString ReceiverUDPBlock::GetType() const { return "ReceiverUDPBlock"; }
...
void ReceiverUDPBlock::RegistrOperationManager(
