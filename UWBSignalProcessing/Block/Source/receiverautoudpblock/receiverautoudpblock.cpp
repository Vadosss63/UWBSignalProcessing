...
ReceiverAutoUDPBlock::ReceiverAutoUDPBlock() : SourceBlock("AutoUDP") {
...
QString ReceiverAutoUDPBlock::GetType() const { return "ReceiverAutoUDPBlock"; }

void ReceiverAutoUDPBlock::paint(QPainter *painter,
...
void ReceiverAutoUDPBlock::RegistrOperationManager(
