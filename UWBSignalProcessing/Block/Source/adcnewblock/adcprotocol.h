...
// uint8_t data[size] - данные команды могут иметь максимальный размер size = 16;
// data состоит
// uint8_t cmd(data[0]) - пользовательская команда
// uint8_t data[1 ... (size - 2)] - данные в рамках команды
// uint8_t crc(data[size -1]) - контрольная сумма, вычисляется простым сумированием всего масиива данных кроме
// последнего
