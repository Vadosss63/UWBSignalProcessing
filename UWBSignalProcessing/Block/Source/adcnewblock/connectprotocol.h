...
// Статусы приемника
enum class ReciverStatus: uint8_t
{
    NO_GRAG = 0,
    OK,
    NO_CONNECT
...
enum class SynchronizationStatus: uint8_t
{
    NO_GRAG = 0,
    OK,
    NO_CONNECT
...
enum class StatusUpdateSPO: uint8_t
{
    OK = 0,
    Error
};
...
{
    SynchronizationStatus synchronizationStatus = SynchronizationStatus::NO_CONNECT;
