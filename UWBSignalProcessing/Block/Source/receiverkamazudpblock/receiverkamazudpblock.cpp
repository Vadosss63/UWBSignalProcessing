...
ReceiverKamazUDPBlock::ReceiverKamazUDPBlock() : SourceBlock("Приемник") {
...
void ReceiverKamazUDPBlock::paint(QPainter *painter,
...
void ReceiverKamazUDPBlock::RegistrOperationManager(
