...
ReceiverKamazUDPModule::ReceiverKamazUDPModule() :
    SourceModule< csignal<double>>(static_cast<uint8_t>(1)), m_frame(0), m_client(10000)
{
...
void ReceiverKamazUDPModule::StartEvent()
{
    StartThread();
}
...
{
    KamazDatagram::PackageKamaz dataRec = m_client.GetData<KamazDatagram::PackageKamaz>();
