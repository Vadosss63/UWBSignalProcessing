...
public:
    ...
    //устанавливает путь файла с csignal и запускает read_service_parameters_in_bin()
    void SetPathFile(const std::string& pathFileSigI, const std::string& pathFileSigQ);
    //производит выталкивание csignal<double> в выходной порт
    //пока, флаг имеет значение m_flagReadFile = true
    //и файл не прочитан до конца. Если файл прочитан, то флаг переводится в положение false,
    //а выталкивание сигнала не происходит.
