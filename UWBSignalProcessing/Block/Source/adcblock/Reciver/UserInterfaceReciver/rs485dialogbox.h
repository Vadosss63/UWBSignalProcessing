...
// Класс осуществяющий взаимодействие между пользователем и
// RecieverControlModule Содержит в себе графическое диологовое окно,
// предоставляющее пользователю возможность изменять парамерты
// RecieverControlModule
