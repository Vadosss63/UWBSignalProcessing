...
void ReciverUWBDialog::WriteCommandSyncronizationTune() {
  ...
  m_ptreeCommandsWriter->AddParameterCommand(
      m_stateValueData.syncronizationTune);
...
void ReciverUWBDialog::WriteCommandUSP1AmplifierTune() {
  ...
  m_ptreeCommandsWriter->AddParameterCommand("address", GetAddress());
  m_ptreeCommandsWriter->AddParameterCommand(
      m_stateValueData.USP1AmplifierTune);
  m_ptreeCommandsWriter->WriteCommand();
...
void ReciverUWBDialog::WriteCommandUSP2AmplifierTune() {
  ...
  m_ptreeCommandsWriter->AddParameterCommand("address", GetAddress());
  m_ptreeCommandsWriter->AddParameterCommand(
      m_stateValueData.USP2AmplifierTune);
  m_ptreeCommandsWriter->WriteCommand();
...
void ReciverUWBDialog::WriteCommandDMAmplifierTune_2() {
  ...
  m_ptreeCommandsWriter->AddParameterCommand("address", GetAddress());
  m_ptreeCommandsWriter->AddParameterCommand(
      m_stateValueData.dm_amplifierTune_2);
  m_ptreeCommandsWriter->WriteCommand();
...
void ReciverUWBDialog::WriteCommandUSP1AmplifierTune_2() {
  ...
  m_ptreeCommandsWriter->AddParameterCommand("address", GetAddress());
  m_ptreeCommandsWriter->AddParameterCommand(
      m_stateValueData.USP1AmplifierTune_2);
  m_ptreeCommandsWriter->WriteCommand();
...
void ReciverUWBDialog::WriteCommandUSP2AmplifierTune_2() {
  ...
  m_ptreeCommandsWriter->AddParameterCommand("address", GetAddress());
  m_ptreeCommandsWriter->AddParameterCommand(
      m_stateValueData.USP2AmplifierTune_2);
  m_ptreeCommandsWriter->WriteCommand();
...
void ReciverUWBDialog::WriteCommandDMSynthesizerTuneFast() {
  ...
  m_ptreeCommandsWriter->AddParameterCommand("address", GetAddress());
  m_ptreeCommandsWriter->AddParameterCommand(
      m_stateValueData.DMSynthesizerTune);
  m_ptreeCommandsWriter->WriteCommand();
...
void ReciverUWBDialog::TimerSenderStop() { m_timerSender->stop(); }
...
void ReciverUWBDialog::ReadCommandSyncronizationTune() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      m_stateValueData.syncronizationTune =
          m_ptreeCommandsWriter->ReadParameterValueUINT8_T(data);
      QString statusStr =
          "Синхронизация: " +
          QString::number(m_stateValueData.syncronizationTune, 16) +
          " (1 байта) ";
...
void ReciverUWBDialog::ReadCommandBandWidthTune() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      m_stateValueData.bandWidthTune =
          m_ptreeCommandsWriter->ReadParameterValueUINT8_T(data);
      QString statusStr =
          "Полоса: " + QString::number(m_stateValueData.bandWidthTune, 16) +
          " (1 байта) ";
...
void ReciverUWBDialog::ReadCommandDMAmplifierTune() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      m_stateValueData.dm_amplifierTune =
          m_ptreeCommandsWriter->ReadParameterValueUINT8_T(data);
      QString statusStr =
          "DM: " + QString::number(m_stateValueData.dm_amplifierTune, 16) +
          " (1 байта) ";
      WriteStatus(statusStr);
    }
  }
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      m_stateValueData.USP1AmplifierTune =
          m_ptreeCommandsWriter->ReadParameterValueUINT8_T(data);
      QString statusStr =
          "USP1: " + QString::number(m_stateValueData.USP1AmplifierTune, 16) +
          " (1 байта) ";
      WriteStatus(statusStr);
    }
  }
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      m_stateValueData.USP2AmplifierTune =
          m_ptreeCommandsWriter->ReadParameterValueUINT8_T(data);
      QString statusStr =
          "USP2: " + QString::number(m_stateValueData.USP2AmplifierTune, 16) +
          " (1 байта) ";
      WriteStatus(statusStr);
    }
  }
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      m_stateValueData.dm_amplifierTune_2 =
          m_ptreeCommandsWriter->ReadParameterValueUINT8_T(data);
      QString statusStr =
          "DM_2: " + QString::number(m_stateValueData.dm_amplifierTune_2, 16) +
          " (1 байта) ";
      WriteStatus(statusStr);
    }
  }
...
void ReciverUWBDialog::ReadCommandUSP1AmplifierTune_2() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      ...
      QString statusStr =
          "USP1_2: " +
          QString::number(m_stateValueData.USP1AmplifierTune_2, 16) +
          " (1 байта) ";
      WriteStatus(statusStr);
    }
  }
...
void ReciverUWBDialog::ReadCommandUSP2AmplifierTune_2() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      ...
      QString statusStr =
          "USP2_2: " +
          QString::number(m_stateValueData.USP2AmplifierTune_2, 16) +
          " (1 байта) ";
      WriteStatus(statusStr);
    }
  }
...
void ReciverUWBDialog::ReadCommandDMSynthesizerTuneFast() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint32_t") {
      m_stateValueData.DMSynthesizerTune =
          m_ptreeCommandsWriter->ReadParameterValueUINT32_T(data);
      QString statusStr =
          "DMSynt: " + QString::number(m_stateValueData.DMSynthesizerTune, 16) +
          " (4 байта) ";
      WriteStatus(statusStr);
    }
  }
...
void ReciverUWBDialog::ReadCommandStatusReciver() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      m_stateValueData.reciverStatus =
          m_ptreeCommandsWriter->ReadParameterValueUINT8_T(data);
      QString statusStr =
          "Status: " + QString::number(m_stateValueData.reciverStatus, 16) +
          " (1 байта) ";
      WriteStatus(statusStr);
    }
  }
...
void ReciverUWBDialog::ReadCommandStatusSynchronition() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint8_t") {
      m_stateValueData.reciverStatusSynchronition =
          m_ptreeCommandsWriter->ReadParameterValueUINT8_T(data);
      QString statusStr =
          "Status: " +
          QString::number(m_stateValueData.reciverStatusSynchronition, 16) +
          " (1 байта) ";
...
void ReciverUWBDialog::ReadCommandAccumSynchronition() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint32_t") {
      ...
      m_stateValueData.accumSynchronition =
          *reinterpret_cast<ValueData::Accum *>(&val);
      QString statusStr =
          "AccumSync: " + QString::number(val, 16) + " (4 байта) ";
      WriteStatusSynchronition(statusStr);
    }
  }
}
...
void ReciverUWBDialog::ReadCommandControlScanSynchronition() {
  ...
  for (auto &data : answer) {
    if (m_ptreeCommandsWriter->ReadTypeParameter(data) == "uint32_t") {
      uint32_t val = m_ptreeCommandsWriter->ReadParameterValueUINT32_T(data);
      m_stateValueData.controlScan =
          *reinterpret_cast<ValueData::ControlScan *>(&val);
      QString statusStr =
          "ControlScan: " + QString::number(val, 16) + " (4 байта) ";
      WriteStatusSynchronition(statusStr);
    }
  }
}
...
void ReciverUWBDialog::InitValueData() {
  ...
  m_stateValueData.dm_amplifierTune =
      static_cast<uint8_t>(m_ui->dialAmpDm->value());
  m_stateValueData.USP1AmplifierTune =
      static_cast<uint8_t>(m_ui->dialAmpUsp1->value());
  m_stateValueData.USP2AmplifierTune =
      static_cast<uint8_t>(m_ui->dialAmpUsp2->value());

  m_stateValueData.dm_amplifierTune_2 =
      static_cast<uint8_t>(m_ui->dialAmpDm_2->value());
  m_stateValueData.USP1AmplifierTune_2 =
      static_cast<uint8_t>(m_ui->dialAmpUsp1_2->value());
  m_stateValueData.USP2AmplifierTune_2 =
      static_cast<uint8_t>(m_ui->dialAmpUsp2_2->value());

  m_stateValueData.DMSynthesizerTune =
      (static_cast<uint32_t>(m_ui->dialSintDmFast->value()) << 24) +
      (static_cast<uint32_t>(m_ui->dialSintDmSlow->value()) << 16);

  m_stateValueData.controlScan.isHandScan = m_ui->isHandScane->isChecked();
  m_stateValueData.controlScan.azimut =
      static_cast<uint8_t>(m_ui->azimutScane->value());

  m_stateValueData.accumSynchronition.isTwoGain =
      static_cast<uint8_t>(m_ui->twoGain->isChecked());
  m_stateValueData.accumSynchronition.countAccum =
      static_cast<uint8_t>(m_ui->accumOneElement->currentIndex());
  m_stateValueData.accumSynchronition.countReciverAntenn =
      static_cast<uint8_t>(m_ui->countReciversAntenn->currentIndex());
  m_stateValueData.accumSynchronition.countTransmiter =
      static_cast<uint8_t>(m_ui->countTransmiters->currentIndex());
}

void ReciverUWBDialog::SetupStatus() {
  Status reciverStatus =
      *reinterpret_cast<Status *>(&m_stateValueData.reciverStatus);
  QString color;
  ...
  m_ui->StatusReciver->setStyleSheet(
...
void ReciverUWBDialog::SetupStatusSynchronition() {
  ...
  m_ui->statusSynchronition->setStyleSheet(
      QString("background-color: %1;").arg(color));
}
...
void ReciverUWBDialog::LoudValueDataToUI() {
  ...
  m_ui->dialSintDmFast->setValue(
      static_cast<uint8_t>(m_stateValueData.DMSynthesizerTune >> 24));
  TimerSenderStop();
  m_ui->dialSintDmSlow->setValue(
      static_cast<uint8_t>(m_stateValueData.DMSynthesizerTune >> 16));
  TimerSenderStop();
  ...
  TimerSenderStop();
  m_ui->accumOneElement->setCurrentIndex(
      m_stateValueData.accumSynchronition.countAccum);
  TimerSenderStop();
  m_ui->countReciversAntenn->setCurrentIndex(
      m_stateValueData.accumSynchronition.countReciverAntenn);
  TimerSenderStop();
  m_ui->countTransmiters->setCurrentIndex(
      m_stateValueData.accumSynchronition.countTransmiter);
  TimerSenderStop();
...
bool ReciverUWBDialog::CheckNoError() {
  if (m_ptreeCommandsWriter->IsNoError())
    return true;
  QString error = "Error send: " +
                  QString::fromStdString(m_ptreeCommandsWriter->GetError());
  WriteStatus(error);
  return false;
}
...
void ReciverUWBDialog::WriteCommandGetSettingReciver() {
  ...
  m_stateValueData.USP1AmplifierTune =
      CreateRequestGetSetting(COMMANDS::USP1Amp);
  m_stateValueData.USP2AmplifierTune =
      CreateRequestGetSetting(COMMANDS::USP2Amp);

  m_stateValueData.dm_amplifierTune_2 =
      CreateRequestGetSetting(COMMANDS::DM_AMP_2);
  m_stateValueData.USP1AmplifierTune_2 =
      CreateRequestGetSetting(COMMANDS::USP1Amp_2);
  m_stateValueData.USP2AmplifierTune_2 =
      CreateRequestGetSetting(COMMANDS::USP2Amp_2);

  m_stateValueData.DMSynthesizerTune =
      CreateRequestGetSetting(COMMANDS::DMSynt);
  m_stateValueData.bandWidthTune = CreateRequestGetSetting(COMMANDS::BAND);
  m_stateValueData.syncronizationTune =
      CreateRequestGetSetting(COMMANDS::SYNCRONIZATION);
}

void ReciverUWBDialog::WriteCommandStatusSynchronition() {
  m_ptreeCommandsWriter->AddName("GetStatusSynchronitionCommand");
  m_ptreeCommandsWriter->AddParameterCommand("address",
                                             GetAddressSynchronition());
  m_ptreeCommandsWriter->WriteCommand();
...
void ReciverUWBDialog::WriteCommandAccumSynchronition() {
  ...
  m_ptreeCommandsWriter->AddParameterCommand("address",
                                             GetAddressSynchronition());
  uint32_t val =
      *(reinterpret_cast<uint32_t *>(&m_stateValueData.accumSynchronition));
...
void ReciverUWBDialog::MakeConnectionsSlot() {
  ...
  m_slots[m_ui->dialAmpUsp2_2] =
      &ReciverUWBDialog::WriteCommandUSP2AmplifierTune_2;
  m_slots[m_ui->dialAmpUsp1_2] =
      &ReciverUWBDialog::WriteCommandUSP1AmplifierTune_2;

  m_slots[m_ui->radioButton_500MHz] =
      &ReciverUWBDialog::WriteCommandBandWidthTune;
  m_slots[m_ui->radioButton_250MHz] =
      &ReciverUWBDialog::WriteCommandBandWidthTune;
  m_slots[m_ui->radioButton_InSync] =
      &ReciverUWBDialog::WriteCommandSyncronizationTune;
  m_slots[m_ui->radioButton_OutSync] =
      &ReciverUWBDialog::WriteCommandSyncronizationTune;
  m_slots[m_ui->dialSintDmFast] =
      &ReciverUWBDialog::WriteCommandDMSynthesizerTuneFast;
  m_slots[m_ui->dialSintDmSlow] =
      &ReciverUWBDialog::WriteCommandDMSynthesizerTuneFast;
  ...
  m_slots[m_ui->GetSettingReciver] =
      &ReciverUWBDialog::WriteCommandGetSettingReciver;

  m_slots[m_ui->statusSynchronition] =
      &ReciverUWBDialog::WriteCommandStatusSynchronition;

  m_slots[m_ui->accumOneElement] =
      &ReciverUWBDialog::WriteCommandAccumSynchronition;
  m_slots[m_ui->countTransmiters] =
      &ReciverUWBDialog::WriteCommandAccumSynchronition;
  m_slots[m_ui->countReciversAntenn] =
      &ReciverUWBDialog::WriteCommandAccumSynchronition;
  ...
  m_slots[m_ui->isHandScane] =
      &ReciverUWBDialog::WriteCommandControlScanSynchronition;
  m_slots[m_ui->azimutScane] =
      &ReciverUWBDialog::WriteCommandControlScanSynchronition;

  m_slots[m_ui->ResetSynchronition] =
      &ReciverUWBDialog::WriteCommandRebootSynchronition;
  m_slots[m_ui->SaveSynchronition] =
      &ReciverUWBDialog::WriteCommandSaveSynchronition;

  connect(m_ui->dialAmpDm, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));
  connect(m_ui->dialAmpUsp1, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));
  connect(m_ui->dialAmpUsp2, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));

  connect(m_ui->dialAmpDm_2, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));
  connect(m_ui->dialAmpUsp1_2, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));
  connect(m_ui->dialAmpUsp2_2, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));

  connect(m_ui->radioButton_500MHz, SIGNAL(clicked()), this,
          SLOT(SendCommand()));
  connect(m_ui->radioButton_250MHz, SIGNAL(clicked()), this,
          SLOT(SendCommand()));
  connect(m_ui->radioButton_InSync, SIGNAL(clicked()), this,
          SLOT(SendCommand()));
  connect(m_ui->radioButton_OutSync, SIGNAL(clicked()), this,
          SLOT(SendCommand()));
  connect(m_ui->dialSintDmFast, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));
  connect(m_ui->dialSintDmSlow, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));
  ...
  connect(m_ui->StatusReciver, SIGNAL(clicked(bool)), this,
          SLOT(SendCommand()));
  connect(m_ui->GetSettingReciver, SIGNAL(clicked(bool)), this,
          SLOT(SendCommand()));

  connect(m_ui->statusSynchronition, SIGNAL(clicked()), this,
          SLOT(SendCommand()));

  connect(m_ui->accumOneElement, SIGNAL(currentIndexChanged(int)), this,
          SLOT(SendCommand()));
  connect(m_ui->countTransmiters, SIGNAL(currentIndexChanged(int)), this,
          SLOT(SendCommand()));
  connect(m_ui->countReciversAntenn, SIGNAL(currentIndexChanged(int)), this,
          SLOT(SendCommand()));
  ...
  connect(m_ui->azimutScane, SIGNAL(valueChanged(int)), this,
          SLOT(SendCommand()));

  connect(m_ui->ResetSynchronition, SIGNAL(clicked(bool)), this,
          SLOT(SendCommand()));
  connect(m_ui->SaveSynchronition, SIGNAL(clicked(bool)), this,
          SLOT(SendCommand()));
}
...
void ReciverUWBDialog::MakeConnections() {
  connect(m_ui->dialAmpDm, SIGNAL(valueChanged(int)), this,
          SLOT(ChangeAmpDm(int)));
  connect(m_ui->dialAmpUsp1, SIGNAL(valueChanged(int)), this,
          SLOT(ChangeAmpUsp1(int)));
  connect(m_ui->dialAmpUsp2, SIGNAL(valueChanged(int)), this,
          SLOT(ChangeAmpUsp2(int)));

  connect(m_ui->dialAmpDm_2, SIGNAL(valueChanged(int)), this,
          SLOT(ChangeAmpDm_2(int)));
  connect(m_ui->dialAmpUsp1_2, SIGNAL(valueChanged(int)), this,
          SLOT(ChangeAmpUsp1_2(int)));
  connect(m_ui->dialAmpUsp2_2, SIGNAL(valueChanged(int)), this,
          SLOT(ChangeAmpUsp2_2(int)));
