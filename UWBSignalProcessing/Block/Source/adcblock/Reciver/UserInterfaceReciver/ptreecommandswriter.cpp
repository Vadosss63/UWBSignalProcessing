...
uint8_t
PTreeCommandsWriter::ReadParameterValueUINT8_T(const std::string &name) {
  return m_ptreeWR.ReadParameterValue<uint8_t>(name);
}

uint16_t
PTreeCommandsWriter::ReadParameterValueUINT16_T(const std::string &name) {
  return m_ptreeWR.ReadParameterValue<uint16_t>(name);
}

uint32_t
PTreeCommandsWriter::ReadParameterValueUINT32_T(const std::string &name) {
...
void PTreeCommandsWriter::Clear() { m_ptreeWR.Clear(); }
...
std::string PTreeCommandsWriter::GetError() { return m_ptreeWR.ReadError(); }

std::list<std::string> PTreeCommandsWriter::GetParametersAnswer() {
  return m_ptreeWR.ParametersKey();
}

bool PTreeCommandsWriter::IsNoError() { return m_ptreeWR.ReadError().empty(); }
...
void PTreeCommandsWriter::AddParameterCommand(const std::string &name,
                                              uint8_t val) {
