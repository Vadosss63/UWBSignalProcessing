...
void ControlWord::SetSync(uint8_t byte) { m_word[NUMBER_BYTE::SYNC] = byte; }

void ControlWord::SetAddr(uint8_t byte) { m_word[NUMBER_BYTE::ADDR] = byte; }
...
bool ControlWord::CheckCRC() const { return m_word.back() == CountCRC(); }

bool ControlWord::CheckCRC(uint8_t byte) const { return byte == CountCRC(); }

void ControlWord::AddCRC() { m_word.back() = CountCRC(); }
