...
// Класс представляет интерфейс настройки приемника, подключенного по интерфейсу RS485
// Для настройки используются основные команды для данного интерфейса, описанные
// в классе RS485Handler
