...
void RecieverControlModule::SetControllerCommands(
...
void RecieverControlModule::Start() { m_controllerCommands->Start(); }

void RecieverControlModule::Stop() { m_controllerCommands->Stop(); }
...
void RecieverControlModule::Update() { Execute(); }
