...
RS485Handler::~RS485Handler() { m_rs485Port.Close(); }
...
std::string RS485Handler::GetError() { return m_rs485Port.GetErrorsMessage(); }

bool RS485Handler::IsNoError() { return m_rs485Port.IsNoError(); }
