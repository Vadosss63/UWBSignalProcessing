...
WriteTargetBlock::WriteTargetBlock() : SinkBlock("Write\nTarget") {
...
AbstractModule *WriteTargetBlock::GetModule() const { return m_module.get(); }

QString WriteTargetBlock::GetType() const { return "WriteTargetBlock"; }
...
void WriteTargetBlock::paint(QPainter *painter,
...
AbstractBlock *PluginBlock::LoudBlock() const { return new WriteTargetBlock; }

void WriteTargetBlock::RegistrOperationManager(
