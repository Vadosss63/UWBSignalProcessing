...
VRLIUDPModule::VRLIUDPModule() :
    SinkModule(1), m_server("192.168.1.1", 12213)
{
...
void VRLIUDPModule::CreateProtocol()
{
    ...
    uint32_t sizeMemory = countTarget * sizeof(DataVRLI) + sizeof(countTarget) + 2;
