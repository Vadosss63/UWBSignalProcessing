...
GLfloat ArrayTarget::GetAMP(GLfloat amp) { return (amp * m_maxY) / m_maxValY; }
...
void ArrayTarget::SetTargetPoint(float range, float valZ, float amp,
                                 size_t index) {
...
GLsizei ArrayTarget::CountPoint() const { return m_countPoint; }

GLfloat ArrayTarget::getMaxX() { return m_maxX; }

void ArrayTarget::setMaxX(const GLfloat &maxX) { m_maxX = maxX; }

GLfloat ArrayTarget::getMaxY() { return m_maxY; }

void ArrayTarget::setMaxY(const GLfloat &maxY) { m_maxY = maxY; }

GLfloat ArrayTarget::getMaxZ() { return m_maxZ; }

void ArrayTarget::setMaxZ(const GLfloat &maxZ) { m_maxZ = maxZ; }
