...
//////////////////
D3TargetBlock::D3TargetBlock() : AbstractScanBlock("3D Target") {
  setToolTip("3D Target");
}

AbstractBlock *D3TargetBlock::Clone() const { return new D3TargetBlock(); }

AbstractModule *D3TargetBlock::GetModule() const { return m_module.get(); }

QString D3TargetBlock::GetType() const { return "D3TargetBlock"; }
...
AbstractBlock *PluginBlock::LoudBlock() const { return new D3TargetBlock; }

void D3TargetBlock::RegistrOperationManager(
