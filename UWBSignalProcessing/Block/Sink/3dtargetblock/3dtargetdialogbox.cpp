...
bool D3TargetDialogBox::SetSetting(QList<std::pair<QString, QVariant>> listSetting)
{
...
void D3TargetDialogBox::SendCommandAbstractModule()
{
    Notification();
}

void D3TargetDialogBox::Attach(ChangeEvent* observer){}
