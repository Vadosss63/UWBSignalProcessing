...
StatisticaleStimateBlock::StatisticaleStimateBlock() : SinkBlock("Stimate") {
...
void StatisticaleStimateBlock::paint(QPainter *painter,
...
void StatisticaleStimateBlock::RegistrOperationManager(
