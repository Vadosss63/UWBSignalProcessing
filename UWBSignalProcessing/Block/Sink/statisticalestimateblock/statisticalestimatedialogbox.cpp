...
StatisticaleStimateDialogBox::StatisticaleStimateDialogBox()
{
    CreateWidget();
}
...
bool StatisticaleStimateDialogBox::SetSetting(QList<std::pair<QString, QVariant> > listSetting)
{
...
void StatisticaleStimateDialogBox::ShowStimate(double mean, double meanValue, double variance, double osv, double osv_to_meanValue)
{
