...
class StatisticaleStimateDialogBox : public AbstractDialogCommand,
                                     public ShowStatisticaleStimate {
  Q_OBJECT
...
public:
  ...
  void ShowStimate(double mean, double meanValue, double variance, double osv,
                   double osv_to_meanValue) override;
