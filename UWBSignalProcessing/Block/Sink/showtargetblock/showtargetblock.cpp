...
AbstractBlock *ShowTargetBlock::Clone() const
{
    return new ShowTargetBlock();
}

AbstractModule* ShowTargetBlock::GetModule() const
{
    return m_module.get();
}

QString ShowTargetBlock::GetType() const
{
    return "ShowTargetBlock";
}
...
void ShowTargetBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
