...
DrawOPGLWidget::DrawOPGLWidget(int size, QWidget *pwgt): QGLWidget (pwgt), m_sizePaintRect(size, 800),
    m_dataLine(size)
{ }
...
QSize DrawOPGLWidget::sizePaintRect() const
{
...
QSize Draw::SizePaintRect() const
{
    return m_sizePaintRect;
}
