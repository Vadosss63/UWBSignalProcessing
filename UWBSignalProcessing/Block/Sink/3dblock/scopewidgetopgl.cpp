...
ScopeWidgetOPGL::ScopeWidgetOPGL(int size, QWidget *pwgt)
    : QGLWidget(pwgt), m_sizePaintRect(size, 256), m_dataLine(size, 255) {}

ScopeWidgetOPGL::~ScopeWidgetOPGL() { ClearBuffer(); }
...
QSize ScopeWidgetOPGL::SizePaintRect() const { return m_sizePaintRect; }
