...
//////////////////
D3Block::D3Block() : AbstractScanBlock("3D") { setToolTip("3D"); }

AbstractBlock *D3Block::Clone() const { return new D3Block(); }

AbstractModule *D3Block::GetModule() const { return m_module.get(); }

QString D3Block::GetType() const { return "3dBlock"; }
...
AbstractBlock *PluginBlock::LoudBlock() const { return new D3Block; }

void D3Block::RegistrOperationManager(
