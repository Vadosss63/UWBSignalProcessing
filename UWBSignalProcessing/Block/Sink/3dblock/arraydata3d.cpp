...
ArrayData3D::ArrayData3D(int countPoint)
    : m_countPoint(countPoint), m_massiveVertex(countPoint * 3),
      m_massiveColor(countPoint * 3, 255) {
  SetXmas();
}
...
int const *ArrayData3D::MassiveVertex() const { return m_massiveVertex.data(); }
...
int ArrayData3D::countPoint() const { return m_countPoint; }
