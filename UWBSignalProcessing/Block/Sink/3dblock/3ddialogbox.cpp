...
void D3DialogBox::SendCommandAbstractModule() { Notification(); }
...
void D3DialogBox::mousePressEvent(QMouseEvent *event) { m_pos = event->pos(); }
...
const GLubyte *ArrayData::MassiveColor() const { return m_massiveColor.data(); }
...
void D3DialogBox::Update() { update(); }
