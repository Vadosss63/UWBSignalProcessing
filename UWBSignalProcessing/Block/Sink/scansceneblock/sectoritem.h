...
public:
    SectorBaseItem(qreal StartAnglePos, qreal Bering, qreal StepAngle, QGraphicsItem *parent);
...
public:
    SectorArc(qreal StartAnglePos,  qreal Bering, qreal StepAngle = 1, QGraphicsItem *parent = nullptr);
...
public:
    SectorRect(qreal StartAnglePos,  float Bering, qreal StepAngle = 1, QGraphicsItem *parent = nullptr);
