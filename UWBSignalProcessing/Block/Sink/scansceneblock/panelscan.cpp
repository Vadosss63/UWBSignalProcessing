...
int PanelScan::GetVerticalShift() const { return ui->threshold->value(); }

int PanelScan::GetGain() const { return ui->gan->value(); }

bool PanelScan::GetUpdateScan() const { return ui->isScanMode->isChecked(); }

int PanelScan::GetUpdateStep() const { return ui->updateStep->value(); }

bool PanelScan::GetIsColorView() const { return ui->isColorScan->isChecked(); }

bool PanelScan::GetIsScanLine() const { return ui->isLineOnScan->isChecked(); }
...
void PanelScan::SetVerticalShift(int shift) { ui->threshold->setValue(shift); }

void PanelScan::SetGain(int gain) { ui->gan->setValue(gain); }
