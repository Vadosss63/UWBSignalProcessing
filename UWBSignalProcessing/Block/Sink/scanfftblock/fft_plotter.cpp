...
QColor DrawCurver::m_colorForIds[]{Qt::white, Qt::red,     Qt::blue,
                                   Qt::cyan,  Qt::magenta, Qt::yellow};

DrawCurver::DrawCurver(QWidget *parent) : QWidget(parent), m_type(typeValue) {
...
QVector<QPointF> &DrawCurver::GetCuver() { return m_curve; }
...
size_t DrawCurver::GetSizeData() { return m_curve.size(); }
