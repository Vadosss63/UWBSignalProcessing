...
//////////////////
ScanfftBlock::ScanfftBlock():
    AbstractScanBlock("Scanfft")
{
    setToolTip("Scanfft");
}

AbstractBlock* ScanfftBlock::Clone() const
{
    return new ScanfftBlock();
}

AbstractModule* ScanfftBlock::GetModule() const
{
    return m_module.get();
}

QString ScanfftBlock::GetType() const
{
    return "ScanfftBlock";
}
...
void ScanfftBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
