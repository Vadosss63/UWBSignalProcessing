...
ScopeComplexDialogBox::ScopeComplexDialogBox(CSignalComplexPlotter *parent,
                                             QWidget *wparent)
...
bool ScopeComplexDialogBox::SetSetting(
...
void ScopeComplexDialogBox::SendCommand() { SetPliting(); }
