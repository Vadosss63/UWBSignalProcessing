...
AbstractModule* ScopeComplexBlock::GetModule() const
{
    return m_module.get();
}

QString ScopeComplexBlock::GetType() const
{
    return "ScopeComplexBlock";
}
...
void ScopeComplexBlock::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget*)
{
...
void ScopeComplexBlock::RegistrOperationManager(AbstractOperationManager* operationManager)
{
    if(m_module)
