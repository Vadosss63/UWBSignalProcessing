...
ScopeBufferDialogBox::ScopeBufferDialogBox(CSignalPlotter* parent, QWidget* wparent):
...
bool ScopeBufferDialogBox::SetSetting(QList<std::pair<QString, QVariant> > listSetting)
{
...
void ScopeBufferDialogBox::SendCommand()
{
    SetPliting();
}
