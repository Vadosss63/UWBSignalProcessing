...
AbstractModule *ScopeBufferBlock::GetModule() const { return m_module.get(); }

QString ScopeBufferBlock::GetType() const { return "ScopeBufferBlock"; }
...
void ScopeBufferBlock::paint(QPainter *painter,
...
AbstractBlock *PluginBlock::LoudBlock() const { return new ScopeBufferBlock; }

void ScopeBufferBlock::RegistrOperationManager(
