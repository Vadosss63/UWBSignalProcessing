...
dspm::AbstractModule &TransmitterUDPBlock::GetModule() { return *m_module; }

QString TransmitterUDPBlock::GetType() { return "TransmitterUDPBlock"; }

void TransmitterUDPBlock::paint(QPainter *painter,
