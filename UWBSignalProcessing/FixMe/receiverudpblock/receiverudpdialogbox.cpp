...
ReceiverUDPDialogBox::ReceiverUDPDialogBox(dspm::ReceiverUDPModule *parent,
                                           QWidget *wparent)
...
void ReceiverUDPDialogBox::SendCommandAbstractModule() {
  ...
  dspm::AbstractModule::PushCommand(new dspm::ReceiverUDPModule::ControlCommand(
...
bool ReceiverUDPDialogBox::SetSetting(
    QList<std::pair<QString, QVariant>> listSetting) {
